  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose N.N.GHOSH SANATAN TEACHERS TRAINING COLLEGE ?</h2>
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            Students rank affordability, student outcomes, and flexibility as the most important factors in choosing a college.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
